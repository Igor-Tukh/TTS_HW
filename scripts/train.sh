...
: ${DATASET_PATH:=libri_training_data}
: ${TRAIN_FILELIST:=libri_transcripts.txt}
: ${VAL_FILELIST:=libri_transcripts_val.txt}
: ${AMP:=true}
: ${SEED:=""}
...
ARGS+=" --checkpoint-path pretrained_models/fastpitch/nvidia_fastpitch_210824.pt"
